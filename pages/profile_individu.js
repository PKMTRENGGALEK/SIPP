    ...
    .then((data) => {
      ...
      container.innerHTML = `
        ...
        <table class="table table-borderless">
          ...
          <tr><td>2. NIP / No. Karpeg</td><td>: ${pegawai.NIP} ${
        pegawai.NOKARPEG ? "/ " + pegawai.NOKARPEG : ""
      }</td></tr>
          <tr><td>3. Tempat, Tgl. Lahir / Umur</td><td>: ${
            pegawai.TEMPAT_LAHIR
          }, ${pegawai.TGL_LAHIR} / ${pegawai.UMUR || "-"}</td></tr>
          <tr><td>4. Jenis Kelamin</td><td>: ${pegawai.JK}</td></tr>
          <tr><td>5. Status Perkawinan</td><td>: ${
            pegawai.STATUS || "-"
          }</td></tr>
          <tr><td>6. Agama</td><td>: ${pegawai.AGAMA || "-"}</td></tr>
          <tr><td>7. Pangkat (Gol. Ruang / TMT)</td><td>: ${
            pegawai.PANGKAT || "-"
          } / ${pegawai.TMT_PANGKAT || "-"}</td></tr>
          <tr><td>8. Jabatan Sekarang / Eselon</td><td>: ${pegawai.JABATAN} / ${
        pegawai.ESELON || "-"
      }</td></tr>
          <tr><td>9. Pendidikan Terakhir / Tahun</td><td>: ${
            pegawai.PENDIDIKAN || "-"
          } / ${pegawai.TAHUN_LULUS || "-"}</td></tr>
          <tr><td>10. Diklat Penjenjangan</td><td>: ${
            pegawai.DIKLAT || "-"
          }</td></tr>
          <tr><td>11. Alamat Rumah / No. Telepon</td><td>: ${
            pegawai.ALAMAT || "-"
          }</td></tr>
        </table>
